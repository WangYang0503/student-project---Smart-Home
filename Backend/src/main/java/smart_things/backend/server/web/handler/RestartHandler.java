...
/**
 * This implementation of a http request handler is called when there are incoming "/restart" requests with which the
 * user wants to restart the server. Uses the AbstractHandler that implements some basic methods for handling http
...
public class RestartHandler extends AbstractHandler {
    ...
    private static final String BANANA_COMMAND = "shutdown -r now";
    // Login data to raspi
    ...
    private static final String RASPI_COMMAND = "shutdown -r now";
     ...
     */
    public RestartHandler(DBManager dbManager, RuleWorker ruleWorker) {
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        MultiLogger.infoNotify("The server will be restarted.");
        try {
            initSSHConnection();
